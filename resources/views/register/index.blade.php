...
<main class="form-registration">
  ...
  @csrf
      ...
      <div class="form-floating">
        <input type="password" name="password" class="form-control rounded-top @error('password') is-invalid @enderror raunded-bottom" id="password" placeholder="Password" required>
